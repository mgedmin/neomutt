...
struct Option MuttVars[] = {
  ...
  { "abort_noattach", DT_QUAD, R_NONE, IP &AbortNoattach, MUTT_NO },
  /*
  ** .pp
  ...
  ** .te
  */
  { "abort_nosubject",  DT_QUAD, R_NONE, IP &AbortNosubject, MUTT_ASKYES },
  /*
  ** .pp
  ...
  */
  { "abort_unmodified", DT_QUAD, R_NONE, IP &AbortUnmodified, MUTT_YES },
  /*
  ** .pp
  ...
  ** .de
  */
  { "allow_8bit",       DT_BOOL, R_NONE, IP &Allow8bit, 1 },
  /*
  ** .pp
  ** Controls whether 8-bit data is converted to 7-bit using either Quoted-
  ** Printable or Base64 encoding when sending mail.
  */
  { "allow_ansi",      DT_BOOL, R_NONE, IP &AllowAnsi, 0 },
  /*
  ** .pp
  ...
  ** $$crypt_timestamp).
  */
  { "arrow_cursor",     DT_BOOL, R_MENU, IP &ArrowCursor, 0 },
  /*
  ** .pp
  ...
  */
#ifdef USE_NNTP
  { "ask_follow_up",    DT_BOOL, R_NONE, IP &AskFollowUp, 0 },
  /*
  ** .pp
  ** If set, NeoMutt will prompt you for follow-up groups before editing
  ** the body of an outgoing message.
  */
  { "ask_x_comment_to", DT_BOOL, R_NONE, IP &AskXCommentTo, 0 },
  /*
  ** .pp
  ...
  */
  { "attach_split",     DT_BOOL, R_NONE, IP &AttachSplit, 1 },
  /*
  ** .pp
  ...
  */
  { "auto_tag",         DT_BOOL, R_NONE, IP &AutoTag, 0 },
  /*
  ** .pp
  ...
  */
  { "autoedit",         DT_BOOL, R_NONE, IP &Autoedit, 0 },
  /*
  ** .pp
  ...
  ** $$beep variable.
  */
  { "bounce",   DT_QUAD, R_NONE, IP &Bounce, MUTT_ASKYES },
  /*
  ** .pp
  ...
  */
  { "bounce_delivered", DT_BOOL, R_NONE, IP &BounceDelivered, 1 },
  /*
  ** .pp
  ** When this variable is \fIset\fP, NeoMutt will include Delivered-To headers when
  ** bouncing messages.  Postfix users may wish to \fIunset\fP this variable.
  */
  { "braille_friendly", DT_BOOL, R_NONE, IP &BrailleFriendly, 0 },
  /*
  ** .pp
  ...
  */
#ifdef USE_NNTP
  { "catchup_newsgroup", DT_QUAD, R_NONE, IP &CatchupNewsgroup, MUTT_ASKYES },
  /*
  ** .pp
  ...
  */
  { "check_mbox_size",  DT_BOOL, R_NONE, IP &CheckMboxSize, 0 },
  /*
  ** .pp
  ...
  */
  { "check_new",        DT_BOOL, R_NONE, IP &CheckNew, 1 },
  /*
  ** .pp
  ...
  */
  { "collapse_unread",  DT_BOOL, R_NONE, IP &CollapseUnread, 1 },
  /*
  ** .pp
  ** When \fIunset\fP, NeoMutt will not collapse a thread if it contains any
  ** unread messages.
  */
  { "collapse_flagged", DT_BOOL, R_NONE, IP &CollapseFlagged, 1 },
  /*
  ** .pp
  ** When \fIunset\fP, NeoMutt will not collapse a thread if it contains any
  ** flagged messages.
  ...
  */
  { "confirmappend",    DT_BOOL, R_NONE, IP &Confirmappend, 1 },
  /*
  ** .pp
  ** When \fIset\fP, NeoMutt will prompt for confirmation when appending messages to
  ** an existing mailbox.
  */
  { "confirmcreate",    DT_BOOL, R_NONE, IP &Confirmcreate, 1 },
  /*
  ** .pp
  ...
  */
  { "copy",             DT_QUAD, R_NONE, IP &Copy, MUTT_YES },
  /*
  ** .pp
  ...
  */
  ...
  { "crypt_autoencrypt",        DT_BOOL, R_NONE, IP &CryptAutoencrypt, 0 },
  /*
  ** .pp
  ...
  ** (Crypto only)
  */
  { "crypt_autopgp",    DT_BOOL, R_NONE, IP &CryptAutopgp, 1 },
  /*
  ** .pp
  ...
  */
  ...
  { "crypt_autosign",   DT_BOOL, R_NONE, IP &CryptAutosign, 0 },
  /*
  ** .pp
  ...
  ** (Crypto only)
  */
  { "crypt_autosmime",  DT_BOOL, R_NONE, IP &CryptAutosmime, 1 },
  /*
  ** .pp
  ** This variable controls whether or not NeoMutt may automatically enable
  ...
  ** $$crypt_autosign, $$crypt_replysign and $$smime_is_default.
  */
  { "crypt_confirmhook",        DT_BOOL, R_NONE, IP &CryptConfirmhook, 1 },
  /*
  ** .pp
  ...
  ** typos are concerned.
  */
  { "crypt_opportunistic_encrypt", DT_BOOL, R_NONE, IP &CryptOpportunisticEncrypt, 0 },
  /*
  ** .pp
  ...
  ** (Crypto only)
  ...
  { "crypt_replyencrypt",       DT_BOOL, R_NONE, IP &CryptReplyencrypt, 1 },
  /*
  ** .pp
  ...
  */
  ...
  { "crypt_replysign",  DT_BOOL, R_NONE, IP &CryptReplysign, 0 },
  /*
  ** .pp
  ...
  */
  ...
  { "crypt_replysignencrypted", DT_BOOL, R_NONE, IP &CryptReplysignencrypted, 0 },
  /*
  ** .pp
  ...
  ** (Crypto only)
  */
  { "crypt_timestamp", DT_BOOL, R_NONE, IP &CryptTimestamp, 1 },
  /*
  ** .pp
  ...
  ** (Crypto only)
  */
  { "crypt_use_gpgme",  DT_BOOL, R_NONE, IP &CryptUseGpgme, 0 },
  /*
  ** .pp
  ...
  */
  { "crypt_use_pka", DT_BOOL, R_NONE, IP &CryptUsePka, 0 },
  /*
  ** .pp
  ...
  */
  ...
  { "crypt_verify_sig", DT_QUAD, R_NONE, IP &CryptVerifySig, MUTT_YES },
  /*
  ** .pp
  ...
  ** regular expression.
  */
  { "delete",           DT_QUAD, R_NONE, IP &Delete, MUTT_ASKYES },
  /*
  ** .pp
  ...
  */
  { "delete_untag",     DT_BOOL, R_NONE, IP &DeleteUntag, 1 },
  /*
  ** .pp
  ...
  */
  { "digest_collapse",  DT_BOOL, R_NONE, IP &DigestCollapse, 1 },
  /*
  ** .pp
  ...
  ** depends on the server whether DSN will be used or not.
  */
  { "duplicate_threads",        DT_BOOL, R_RESORT|R_RESORT_INIT|R_INDEX, IP &DuplicateThreads, 1 },
  /*
  ** .pp
  ...
  ** in the thread tree.
  */
  { "edit_headers",     DT_BOOL, R_NONE, IP &EditHeaders, 0 },
  /*
  ** .pp
  ...
  */
  { "encode_from",      DT_BOOL, R_NONE, IP &EncodeFrom, 0 },
  /*
  ** .pp
  ...
  */
  { "fast_reply",       DT_BOOL, R_NONE, IP &FastReply, 0 },
  /*
  ** .pp
  ...
  */
  { "fcc_attach",       DT_QUAD, R_NONE, IP &FccAttach, MUTT_YES },
  /*
  ** .pp
  ** This variable controls whether or not attachments on outgoing messages
  ** are saved along with the main body of your message.
  */
  { "fcc_clear",        DT_BOOL, R_NONE, IP &FccClear, 0 },
  /*
  ** .pp
  ...
  ** (PGP only)
  */
  { "flag_safe", DT_BOOL, R_NONE, IP &FlagSafe, 0 },
  /*
  ** .pp
  ...
  */
  { "followup_to",      DT_BOOL, R_NONE, IP &FollowupTo, 1 },
  /*
  ** .pp
  ...
  */
#ifdef USE_NNTP
  { "followup_to_poster", DT_QUAD, R_NONE, IP &FollowupToPoster, MUTT_ASKYES },
  /*
  ** .pp
  ...
  */
#endif
  { "force_name",       DT_BOOL, R_NONE, IP &ForceName, 0 },
  /*
  ** .pp
  ...
  ** the section on $$index_format.  See also $$attribution_locale.
  */
  { "forward_decode",   DT_BOOL, R_NONE, IP &ForwardDecode, 1 },
  /*
  ** .pp
  ...
  */
  ...
  /*
  */
  { "forward_decrypt",  DT_BOOL, R_NONE, IP &ForwardDecrypt, 1 },
  /*
  ** .pp
  ...
  */
  ...
  /*
  */
  { "forward_edit",     DT_QUAD, R_NONE, IP &ForwardEdit, MUTT_YES },
  /*
  ** .pp
  ...
  */
  ...
  /*
  */
  { "forward_quote",    DT_BOOL, R_NONE, IP &ForwardQuote, 0 },
  /*
  ** .pp
  ...
  */
  ...
  /*
  */
  { "forward_references", DT_BOOL, R_NONE, IP &ForwardReferences, 0 },
  /*
  ** .pp
  ...
  */
  { "header",           DT_BOOL, R_NONE, IP &Header, 0 },
  /*
  ** .pp
  ...
  */
  ...
  { "header_cache_compress", DT_BOOL, R_NONE, IP &HeaderCacheCompress, 1 },
  /*
  ** .pp
...
#endif /* USE_HCACHE */
  { "header_color_partial", DT_BOOL, R_PAGER_FLOW, IP &HeaderColorPartial, 0 },
  /*
  ** .pp
  ...
  */
  { "help",             DT_BOOL, R_REFLOW, IP &Help, 1 },
  /*
  ** .pp
  ...
  */
  { "hidden_host",      DT_BOOL, R_NONE, IP &HiddenHost, 0 },
  /*
  ** .pp
  ...
  */
  { "hide_limited",     DT_BOOL, R_TREE|R_INDEX, IP &HideLimited, 0 },
  /*
  ** .pp
  ** When \fIset\fP, NeoMutt will not show the presence of messages that are hidden
  ** by limiting, in the thread tree.
  */
  { "hide_missing",     DT_BOOL, R_TREE|R_INDEX, IP &HideMissing, 1 },
  /*
  ** .pp
  ** When \fIset\fP, NeoMutt will not show the presence of missing messages in the
  ** thread tree.
  */
  { "hide_thread_subject", DT_BOOL, R_TREE|R_INDEX, IP &HideThreadSubject, 1 },
  /*
  ** .pp
  ...
  ** displayed sibling.
  */
  { "hide_top_limited", DT_BOOL, R_TREE|R_INDEX, IP &HideTopLimited, 0 },
  /*
  ** .pp
  ** When \fIset\fP, NeoMutt will not show the presence of messages that are hidden
  ...
  */
  { "hide_top_missing", DT_BOOL, R_TREE|R_INDEX, IP &HideTopMissing, 1 },
  /*
  ** .pp
  ...
  */
  { "history_remove_dups", DT_BOOL, R_NONE, IP &HistoryRemoveDups, 0 },
  /*
  ** .pp
  ...
  */
  { "honor_disposition", DT_BOOL, R_NONE, IP &HonorDisposition, 0 },
  /*
  ** .pp
  ...
  */
  { "honor_followup_to", DT_QUAD, R_NONE, IP &HonorFollowupTo, MUTT_YES },
  /*
  ** .pp
  ...
  */
#ifdef HAVE_LIBIDN
  { "idn_decode",       DT_BOOL, R_MENU, IP &IdnDecode, 1 },
  /*
  ** .pp
  ...
  */
  { "idn_encode",       DT_BOOL, R_MENU, IP &IdnEncode, 1 },
  /*
  ** .pp
  ...
  */
#endif /* HAVE_LIBIDN */
  { "ignore_linear_white_space",    DT_BOOL, R_NONE, IP &IgnoreLinearWhiteSpace, 0 },
  /*
  ** .pp
  ...
  */
  { "ignore_list_reply_to", DT_BOOL, R_NONE, IP &IgnoreListReplyTo, 0 },
  /*
  ** .pp
  ...
  */
  { "imap_check_subscribed",  DT_BOOL, R_NONE, IP &ImapCheckSubscribed, 0 },
  /*
   ** .pp
  ...
  */
  { "imap_idle",                DT_BOOL, R_NONE, IP &ImapIdle, 0 },
  /*
  ** .pp
  ...
  */
  { "imap_list_subscribed",     DT_BOOL, R_NONE, IP &ImapListSubscribed, 0 },
  /*
  ** .pp
  ...
  */
  { "imap_passive",             DT_BOOL, R_NONE, IP &ImapPassive, 1 },
  /*
  ** .pp
  ...
  ** is slow.
  */
  { "imap_peek", DT_BOOL, R_NONE, IP &ImapPeek, 1 },
  /*
  ** .pp
  ...
  */
  { "imap_servernoise",         DT_BOOL, R_NONE, IP &ImapServernoise, 1 },
  /*
  ** .pp
  ...
  */
#endif
  { "implicit_autoview", DT_BOOL,R_NONE, IP &ImplicitAutoview, 0 },
  /*
  ** .pp
  ...
  ** form.
  */
  { "include",          DT_QUAD, R_NONE, IP &Include, MUTT_ASKYES },
  /*
  ** .pp
  ** Controls whether or not a copy of the message(s) you are replying to
  ** is included in your reply.
  */
  { "include_onlyfirst",        DT_BOOL, R_NONE, IP &IncludeOnlyfirst, 0 },
  /*
  ** .pp
  ...
  */
  { "keep_flagged", DT_BOOL, R_NONE, IP &KeepFlagged, 0 },
  /*
  ** .pp
  ...
  */
  { "mail_check_recent",DT_BOOL, R_NONE, IP &MailCheckRecent, 1 },
  /*
  ** .pp
  ...
  */
  { "mail_check_stats", DT_BOOL, R_NONE, IP &MailCheckStats, 0 },
  /*
  ** .pp
  ...
  */
  { "mailcap_sanitize", DT_BOOL, R_NONE, IP &MailcapSanitize, 1 },
  /*
  ** .pp
  ...
  */
#ifdef USE_HCACHE
  { "maildir_header_cache_verify", DT_BOOL, R_NONE, IP &MaildirHeaderCacheVerify, 1 },
  /*
  ** .pp
  ...
  */
#endif
  { "maildir_trash", DT_BOOL, R_NONE, IP &MaildirTrash, 0 },
  /*
  ** .pp
  ...
  ** mailbox types.
  */
  { "maildir_check_cur", DT_BOOL, R_NONE, IP &MaildirCheckCur, 0 },
  /*
  ** .pp
  ...
  */
  { "mark_old",         DT_BOOL, R_BOTH, IP &MarkOld, 1 },
  /*
  ** .pp
  ...
  */
  { "markers",          DT_BOOL, R_PAGER_FLOW, IP &Markers, 1 },
  /*
  ** .pp
  ...
  */
  { "menu_move_off",    DT_BOOL, R_NONE, IP &MenuMoveOff, 1 },
  /*
  ** .pp
  ...
  */
  { "menu_scroll",      DT_BOOL, R_NONE, IP &MenuScroll, 0 },
  /*
  ** .pp
  ...
  */
  ...
  { "message_cache_clean", DT_BOOL, R_NONE, IP &MessageCacheClean, 0 },
  /*
  ** .pp
  ...
  */
  ...
  /*
  */
  { "meta_key",         DT_BOOL, R_NONE, IP &MetaKey, 0 },
  /*
  ** .pp
  ...
  */
  { "mime_forward",     DT_QUAD, R_NONE, IP &MimeForward, MUTT_NO },
  /*
  ** .pp
  ...
  */
  { "mime_forward_decode", DT_BOOL, R_NONE, IP &MimeForwardDecode, 0 },
  /*
  ** .pp
  ** Controls the decoding of complex MIME messages into \fCtext/plain\fP when
  ...
  */
  ...
  /*
  */
  { "mime_forward_rest", DT_QUAD, R_NONE, IP &MimeForwardRest, MUTT_YES },
  /*
  ** .pp
  ...
  */
#ifdef USE_NNTP
  { "mime_subject",     DT_BOOL, R_NONE, IP &MimeSubject, 1 },
  /*
  ** .pp
  ...
  ** ``file -bi''.
  */
  { "mime_type_query_first", DT_BOOL, R_NONE, IP &MimeTypeQueryFirst, 0 },
  /*
  ** .pp
  ...
  */
#endif
  { "move",             DT_QUAD, R_NONE, IP &Move, MUTT_NO },
  /*
  ** .pp
  ...
  ** a ``$mbox-hook'' command.
  */
  { "narrow_tree",      DT_BOOL, R_TREE|R_INDEX, IP &NarrowTree, 0 },
  /*
  ** .pp
  ...
  */
  { "nntp_listgroup",   DT_BOOL, R_NONE, IP &NntpListgroup, 1 },
  /*
  ** .pp
  ** This variable controls whether or not existence of each article is
  ** checked when newsgroup is entered.
  */
  { "nntp_load_description", DT_BOOL, R_NONE, IP &NntpLoadDescription, 1 },
  /*
  ** .pp
  ...
  */
   ...
   */
  { "nm_record", DT_BOOL, R_NONE, IP &NmRecord, 0 },
  /*
   ** .pp
  ...
  */
  { "pager_stop",       DT_BOOL, R_NONE, IP &PagerStop, 0 },
  /*
  ** .pp
  ...
  ** function.
  */
  { "pgp_auto_decode", DT_BOOL, R_NONE, IP &PgpAutoDecode, 0 },
  /*
  ** .pp
  ...
  */
  ...
  { "pgp_autoinline",           DT_BOOL, R_NONE, IP &PgpAutoinline, 0 },
  /*
  ** .pp
  ...
  ** (PGP only)
  */
  { "pgp_check_exit",   DT_BOOL, R_NONE, IP &PgpCheckExit, 1 },
  /*
  ** .pp
  ...
  ** (PGP only)
  */
  { "pgp_ignore_subkeys", DT_BOOL, R_NONE, IP &PgpIgnoreSubkeys, 1 },
  /*
  ** .pp
  ...
  ** (PGP only)
  */
  { "pgp_long_ids",     DT_BOOL, R_NONE, IP &PgpLongIds, 1 },
  /*
  ** .pp
  ...
  ** (PGP only)
  */
  { "pgp_mime_auto", DT_QUAD, R_NONE, IP &PgpMimeAuto, MUTT_ASKYES },
  /*
  ** .pp
  ...
  */
  ...
  { "pgp_replyinline",          DT_BOOL, R_NONE, IP &PgpReplyinline, 0 },
  /*
  ** .pp
  ** Setting this variable will cause NeoMutt to always attempt to
  ...
  **
  */
  { "pgp_retainable_sigs", DT_BOOL, R_NONE, IP &PgpRetainableSigs, 0 },
  /*
  ** .pp
  ...
  ** (PGP only)
  */
  { "pgp_self_encrypt",    DT_BOOL, R_NONE, IP &PgpSelfEncrypt, 0 },
  /*
  ** .pp
  ...
  ** (PGP only)
  */
  { "pgp_show_unusable", DT_BOOL, R_NONE, IP &PgpShowUnusable, 1 },
  /*
  ** .pp
  ...
  ** (PGP only)
  */
  { "pgp_strict_enc",   DT_BOOL, R_NONE, IP &PgpStrictEnc, 1 },
  /*
  ** .pp
  ...
  ** (PGP only)
  */
  { "pgp_use_gpg_agent", DT_BOOL, R_NONE, IP &PgpUseGpgAgent, 0 },
  /*
  ** .pp
  ...
  ** (PGP only)
  */
  { "pipe_decode",      DT_BOOL, R_NONE, IP &PipeDecode, 0 },
  /*
  ** .pp
  ...
  */
  { "pipe_split",       DT_BOOL, R_NONE, IP &PipeSplit, 0 },
  /*
  ** .pp
  ...
  */
#ifdef USE_POP
  { "pop_auth_try_all", DT_BOOL, R_NONE, IP &PopAuthTryAll, 1 },
  /*
  ** .pp
  ...
  */
  { "pop_delete",       DT_QUAD, R_NONE, IP &PopDelete, MUTT_ASKNO },
  /*
  ** .pp
  ...
  */
  { "pop_last",         DT_BOOL, R_NONE, IP &PopLast, 0 },
  /*
  ** .pp
  ...
  */
  { "pop_reconnect",    DT_QUAD, R_NONE, IP &PopReconnect, MUTT_ASKYES },
  /*
  ** .pp
  ...
  */
#ifdef USE_NNTP
  { "post_moderated",   DT_QUAD, R_NONE, IP &PostModerated, MUTT_ASKYES },
  /*
  ** .pp
  ...
  */
#endif
  { "postpone",         DT_QUAD, R_NONE, IP &Postpone, MUTT_ASKYES },
  /*
  ** .pp
  ...
  */
  { "postpone_encrypt",    DT_BOOL, R_NONE, IP &PostponeEncrypt, 0 },
  /*
  ** .pp
  ...
  */
#endif /* USE_SOCKET */
  { "print",            DT_QUAD, R_NONE, IP &Print, MUTT_ASKNO },
  /*
  ** .pp
  ...
  */
  ...
  /*
  */
  { "print_decode",     DT_BOOL, R_NONE, IP &PrintDecode, 1 },
  /*
  ** .pp
  ...
  */
  { "print_split",      DT_BOOL, R_NONE, IP &PrintSplit,  0 },
  /*
  ** .pp
  ...
  */
  { "prompt_after",     DT_BOOL, R_NONE, IP &PromptAfter, 1 },
  /*
  ** .pp
  ...
  */
  { "quit",             DT_QUAD, R_NONE, IP &Quit, MUTT_YES },
  /*
  ** .pp
  ...
  */
  { "read_only",        DT_BOOL, R_NONE, IP &ReadOnly, 0 },
  /*
  ** .pp
  ...
  */
  { "recall",           DT_QUAD, R_NONE, IP &Recall, MUTT_ASKYES },
  /*
  ** .pp
  ...
  */
  { "reflow_space_quotes",      DT_BOOL, R_NONE, IP &ReflowSpaceQuotes, 1 },
  /*
  ** .pp
  ...
  */
  { "reflow_text",      DT_BOOL, R_NONE, IP &ReflowText, 1 },
  /*
  ** .pp
  ...
  ** the German "Aw:".
  */
  { "reply_self",       DT_BOOL, R_NONE, IP &ReplySelf, 0 },
  /*
  ** .pp
  ...
  */
  { "reply_to",         DT_QUAD, R_NONE, IP &ReplyTo, MUTT_ASKYES },
  /*
  ** .pp
  ...
  */
  { "reply_with_xorig", DT_BOOL, R_NONE, IP &ReplyWithXorig, 0 },
  /*
  ** .pp
  ...
  */
  { "resolve",          DT_BOOL, R_NONE, IP &Resolve, 1 },
  /*
  ** .pp
  ...
  */
  { "resume_draft_files", DT_BOOL, R_NONE, IP &ResumeDraftFiles, 0 },
  /*
  ** .pp
  ...
  */
  { "resume_edited_draft_files", DT_BOOL, R_NONE, IP &ResumeEditedDraftFiles, 1 },
  /*
  ** .pp
  ...
  */
  { "reverse_alias",    DT_BOOL, R_BOTH, IP &ReverseAlias, 0 },
  /*
  ** .pp
  ...
  */
  { "reverse_name",     DT_BOOL, R_BOTH, IP &ReverseName, 0 },
  /*
  ** .pp
  ...
  ** Also see the ``$alternates'' command.
  */
  { "reverse_realname", DT_BOOL, R_BOTH, IP &ReverseRealname, 1 },
  /*
  ** .pp
  ...
  */
  { "rfc2047_parameters", DT_BOOL, R_NONE, IP &Rfc2047Parameters, 0 },
  /*
  ** .pp
  ...
  */
  { "save_address",     DT_BOOL, R_NONE, IP &SaveAddress, 0 },
  /*
  ** .pp
  ...
  */
  { "save_empty",       DT_BOOL, R_NONE, IP &SaveEmpty, 1 },
  /*
  ** .pp
  ...
  ** $$history_file file.
  */
  { "save_name",        DT_BOOL, R_NONE, IP &SaveName, 0 },
  /*
  ** .pp
  ...
  */
  { "score",            DT_BOOL, R_NONE, IP &Score, 1 },
  /*
  ** .pp
  ...
  */
#ifdef USE_NNTP
  { "save_unsubscribed", DT_BOOL, R_NONE, IP &SaveUnsubscribed, 0 },
  /*
  ** .pp
  ** When \fIset\fP, info about unsubscribed newsgroups will be saved into
  ** ``newsrc'' file and into cache.
  */
  { "show_new_news",    DT_BOOL, R_NONE, IP &ShowNewNews, 1 },
  /*
  ** .pp
  ...
  */
  { "show_only_unread", DT_BOOL, R_NONE, IP &ShowOnlyUnread, 0 },
  /*
  ** .pp
  ...
  */
  { "sidebar_folder_indent", DT_BOOL, R_SIDEBAR, IP &SidebarFolderIndent, 0 },
  /*
  ** .pp
  ...
  */
  { "sidebar_new_mail_only", DT_BOOL, R_SIDEBAR, IP &SidebarNewMailOnly, 0 },
  /*
  ** .pp
  ...
  */
  { "sidebar_next_new_wrap", DT_BOOL, R_NONE, IP &SidebarNextNewWrap, 0 },
  /*
  ** .pp
  ...
  ** the end of the list.
  */
  { "sidebar_on_right", DT_BOOL, R_BOTH|R_REFLOW, IP &SidebarOnRight, 0 },
  /*
  ** .pp
  ** When set, the sidebar will appear on the right-hand side of the screen.
  */
  { "sidebar_short_path", DT_BOOL, R_SIDEBAR, IP &SidebarShortPath, 0 },
  /*
  ** .pp
  ...
  */
  { "sidebar_visible", DT_BOOL, R_REFLOW, IP &SidebarVisible, 0 },
  /*
  ** .pp
  ...
  */
#endif
  { "sig_dashes",       DT_BOOL, R_NONE, IP &SigDashes, 1 },
  /*
  ** .pp
  ...
  */
  { "sig_on_top",       DT_BOOL, R_NONE, IP &SigOnTop, 0 },
  /*
  ** .pp
  ...
  */
  { "smart_wrap",       DT_BOOL, R_PAGER_FLOW, IP &SmartWrap, 1 },
  /*
  ** .pp
  ...
  */
  { "smime_ask_cert_label",     DT_BOOL, R_NONE, IP &SmimeAskCertLabel, 1 },
  /*
  ** .pp
  ...
  ** (S/MIME only)
  */
  { "smime_decrypt_use_default_key",    DT_BOOL, R_NONE, IP &SmimeDecryptUseDefaultKey, 1 },
  /*
  ** .pp
  ...
  ** (S/MIME only)
  */
  { "smime_is_default", DT_BOOL,  R_NONE, IP &SmimeIsDefault, 0 },
  /*
  ** .pp
  ...
  ** (S/MIME only)
  */
  { "smime_self_encrypt",    DT_BOOL, R_NONE, IP &SmimeSelfEncrypt, 0 },
  /*
  ** .pp
  ...
  ** order (example: ``\fCset sort_browser=reverse-date\fP'').
  */
  { "sort_re",          DT_BOOL, R_INDEX|R_RESORT|R_RESORT_INIT, IP &SortRe, 1 },
  /*
  ** .pp
  ...
  ** key.
  */
  { "ssl_force_tls",            DT_BOOL, R_NONE, IP &SslForceTls, 0 },
  /*
   ** .pp
  ...
  */
#endif /* USE_SSL_GNUTLS */
  { "ssl_starttls", DT_QUAD, R_NONE, IP &SslStarttls, MUTT_YES },
  /*
  ** .pp
  ...
  */
#ifdef USE_SSL_OPENSSL
  { "ssl_use_sslv2", DT_BOOL, R_NONE, IP &SslUseSslv2, 0 },
  /*
  ** .pp
  ...
  */
  ...
  { "ssl_use_sslv3", DT_BOOL, R_NONE, IP &SslUseSslv3, 0 },
  /*
  ** .pp
  ...
  ** considered fundamentally insecure and are no longer recommended.
  */
  { "ssl_use_tlsv1", DT_BOOL, R_NONE, IP &SslUseTlsv1, 1 },
  /*
  ** .pp
  ** This variable specifies whether to attempt to use TLSv1.0 in the
  ** SSL authentication process.
  */
  { "ssl_use_tlsv1_1", DT_BOOL, R_NONE, IP &SslUseTlsv11, 1 },
  /*
  ** .pp
  ** This variable specifies whether to attempt to use TLSv1.1 in the
  ** SSL authentication process.
  */
  { "ssl_use_tlsv1_2", DT_BOOL, R_NONE, IP &SslUseTlsv12, 1 },
  /*
  ** .pp
  ...
  */
#ifdef USE_SSL_OPENSSL
  { "ssl_usesystemcerts", DT_BOOL, R_NONE, IP &SslUsesystemcerts, 1 },
  /*
  ** .pp
  ...
  */
#endif
  { "ssl_verify_dates", DT_BOOL, R_NONE, IP &SslVerifyDates, 1 },
  /*
  ** .pp
  ...
  */
  { "ssl_verify_host", DT_BOOL, R_NONE, IP &SslVerifyHost, 1 },
  /*
  ** .pp
  ** If \fIset\fP (the default), NeoMutt will not automatically accept a server
  ...
  */
  ...
  { "ssl_verify_partial_chains", DT_BOOL, R_NONE, IP &SslVerifyPartialChains, 0 },
  /*
  ** .pp
  ...
  */
  { "status_on_top",    DT_BOOL, R_REFLOW, IP &StatusOnTop, 0 },
  /*
  ** .pp
  ...
  */
  { "strict_threads",   DT_BOOL, R_RESORT|R_RESORT_INIT|R_INDEX, IP &StrictThreads, 0 },
  /*
  ** .pp
  ...
  ** behavior.
  */
  { "suspend",          DT_BOOL, R_NONE, IP &Suspend, 1 },
  /*
  ** .pp
  ...
  */
  { "text_flowed",      DT_BOOL, R_NONE, IP &TextFlowed,  0 },
  /*
  ** .pp
  ...
  */
  { "thorough_search",  DT_BOOL, R_NONE, IP &ThoroughSearch, 1 },
  /*
  ** .pp
  ...
  */
  { "thread_received",  DT_BOOL, R_RESORT|R_RESORT_INIT|R_INDEX, IP &ThreadReceived, 0 },
  /*
  ** .pp
  ** When \fIset\fP, NeoMutt uses the date received rather than the date sent
  ** to thread messages by subject.
  */
  { "tilde",            DT_BOOL, R_PAGER, IP &Tilde, 0 },
  /*
  ** .pp
  ...
  ** ``$$status_format''.
  */
  { "ts_enabled",        DT_BOOL,  R_BOTH, IP &TsEnabled, 0 },
  ...
  */
#endif
  { "uncollapse_jump",  DT_BOOL, R_NONE, IP &UncollapseJump, 0 },
  /*
  ** .pp
  ** When \fIset\fP, NeoMutt will jump to the next unread message, if any,
  ** when the current thread is \fIun\fPcollapsed.
  */
  { "uncollapse_new",   DT_BOOL, R_NONE, IP &UncollapseNew, 1 },
  /*
  ** .pp
  ...
  */
  { "use_8bitmime",     DT_BOOL, R_NONE, IP &Use8bitmime, 0 },
  /*
  ** .pp
  ...
  */
  { "use_domain",       DT_BOOL, R_NONE, IP &UseDomain, 1 },
  /*
  ** .pp
  ...
  */
  { "use_envelope_from",        DT_BOOL, R_NONE, IP &UseEnvelopeFrom, 0 },
  /*
   ** .pp
  ...
  /*
  */
  { "use_from",         DT_BOOL, R_NONE, IP &UseFrom, 1 },
  /*
  ** .pp
  ...
  */
  ...
  { "use_ipv6",         DT_BOOL, R_NONE, IP &UseIpv6, 1 },
  /*
  ** .pp
  ...
  */
  ...
  { "user_agent",       DT_BOOL, R_NONE, IP &UserAgent, 1 },
  /*
  ** .pp
  ...
  */
  { "virtual_spoolfile", DT_BOOL, R_NONE, IP &VirtualSpoolfile, 0 },
  /*
  ** .pp
  ...
  */
#endif
  { "wait_key",         DT_BOOL, R_NONE, IP &WaitKey, 1 },
  /*
  ** .pp
  ...
  */
  { "wrap_search",      DT_BOOL, R_NONE, IP &WrapSearch, 1 },
  /*
  ** .pp
  ...
  */
  { "write_bcc",        DT_BOOL, R_NONE, IP &WriteBcc, 1 },
  /*
  ** .pp
  ...
  */
#ifdef USE_NNTP
  { "x_comment_to",     DT_BOOL, R_NONE, IP &XCommentTo, 0 },
  /*
  ** .pp
  ...
  */
#endif
  { "collapse_all",     DT_BOOL, R_NONE, IP &CollapseAll, 0 },
  /*
  ** .pp
  ** When \fIset\fP, NeoMutt will collapse all threads when entering a folder.
  */
  /*--*/
  { "pgp_encrypt_self",   DT_QUAD, R_NONE, IP &PgpEncryptSelf,   MUTT_NO },
  { "smime_encrypt_self", DT_QUAD, R_NONE, IP &SmimeEncryptSelf, MUTT_NO },
  { NULL, 0, 0, 0, 0 },
};
