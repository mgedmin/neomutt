...
struct Option MuttVars[] = {
  ...
  { "abort_noattach", DT_QUAD, R_NONE, IP &OPT_ABORT_NOATTACH, MUTT_NO },
  /*
  ** .pp
  ...
  ** .te
  */
  { "abort_nosubject",  DT_QUAD, R_NONE, IP &OPT_ABORT_NOSUBJECT, MUTT_ASKYES },
  /*
  ** .pp
  ...
  */
  { "abort_unmodified", DT_QUAD, R_NONE, IP &OPT_ABORT_UNMODIFIED, MUTT_YES },
  /*
  ** .pp
  ...
  ** .de
  */
  { "allow_8bit",       DT_BOOL, R_NONE, IP &OPT_ALLOW_8BIT, 1 },
  /*
  ** .pp
  ** Controls whether 8-bit data is converted to 7-bit using either Quoted-
  ** Printable or Base64 encoding when sending mail.
  */
  { "allow_ansi",      DT_BOOL, R_NONE, IP &OPT_ALLOW_ANSI, 0 },
  /*
  ** .pp
  ...
  ** $$crypt_timestamp).
  */
  { "arrow_cursor",     DT_BOOL, R_MENU, IP &OPT_ARROW_CURSOR, 0 },
  /*
  ** .pp
  ...
  */
#ifdef USE_NNTP
  { "ask_follow_up",    DT_BOOL, R_NONE, IP &OPT_ASK_FOLLOW_UP, 0 },
  /*
  ** .pp
  ** If set, NeoMutt will prompt you for follow-up groups before editing
  ** the body of an outgoing message.
  */
  { "ask_x_comment_to", DT_BOOL, R_NONE, IP &OPT_ASK_X_COMMENT_TO, 0 },
  /*
  ** .pp
  ...
  */
  { "attach_split",     DT_BOOL, R_NONE, IP &OPT_ATTACH_SPLIT, 1 },
  /*
  ** .pp
  ...
  */
  { "auto_tag",         DT_BOOL, R_NONE, IP &OPT_AUTO_TAG, 0 },
  /*
  ** .pp
  ...
  */
  { "autoedit",         DT_BOOL, R_NONE, IP &OPT_AUTOEDIT, 0 },
  /*
  ** .pp
  ...
  ** Also see $$fast_reply.
  */
  { "beep",             DT_BOOL, R_NONE, IP &OPT_BEEP, 1 },
  /*
  ** .pp
  ** When this variable is \fIset\fP, NeoMutt will beep when an error occurs.
  */
  { "beep_new",         DT_BOOL, R_NONE, IP &OPT_BEEP_NEW, 0 },
  /*
  ** .pp
  ...
  ** $$beep variable.
  */
  { "bounce",   DT_QUAD, R_NONE, IP &OPT_BOUNCE, MUTT_ASKYES },
  /*
  ** .pp
  ...
  */
  { "bounce_delivered", DT_BOOL, R_NONE, IP &OPT_BOUNCE_DELIVERED, 1 },
  /*
  ** .pp
  ** When this variable is \fIset\fP, NeoMutt will include Delivered-To headers when
  ** bouncing messages.  Postfix users may wish to \fIunset\fP this variable.
  */
  { "braille_friendly", DT_BOOL, R_NONE, IP &OPT_BRAILLE_FRIENDLY, 0 },
  /*
  ** .pp
  ...
  */
#ifdef USE_NNTP
  { "catchup_newsgroup", DT_QUAD, R_NONE, IP &OPT_CATCHUP_NEWSGROUP, MUTT_ASKYES },
  /*
  ** .pp
  ...
  */
  { "check_mbox_size",  DT_BOOL, R_NONE, IP &OPT_CHECK_MBOX_SIZE, 0 },
  /*
  ** .pp
  ...
  */
  { "check_new",        DT_BOOL, R_NONE, IP &OPT_CHECK_NEW, 1 },
  /*
  ** .pp
  ...
  */
  { "collapse_unread",  DT_BOOL, R_NONE, IP &OPT_COLLAPSE_UNREAD, 1 },
  /*
  ** .pp
  ** When \fIunset\fP, NeoMutt will not collapse a thread if it contains any
  ** unread messages.
  */
  { "collapse_flagged", DT_BOOL, R_NONE, IP &OPT_COLLAPSE_FLAGGED, 1 },
  /*
  ** .pp
  ** When \fIunset\fP, NeoMutt will not collapse a thread if it contains any
  ** flagged messages.
  ...
  */
  { "confirmappend",    DT_BOOL, R_NONE, IP &OPT_CONFIRMAPPEND, 1 },
  /*
  ** .pp
  ** When \fIset\fP, NeoMutt will prompt for confirmation when appending messages to
  ** an existing mailbox.
  */
  { "confirmcreate",    DT_BOOL, R_NONE, IP &OPT_CONFIRMCREATE, 1 },
  /*
  ** .pp
  ...
  */
  { "copy",             DT_QUAD, R_NONE, IP &OPT_COPY, MUTT_YES },
  /*
  ** .pp
  ...
  */
  ...
  { "crypt_autoencrypt",        DT_BOOL, R_NONE, IP &OPT_CRYPT_AUTOENCRYPT, 0 },
  /*
  ** .pp
  ...
  ** (Crypto only)
  */
  { "crypt_autopgp",    DT_BOOL, R_NONE, IP &OPT_CRYPT_AUTOPGP, 1 },
  /*
  ** .pp
  ...
  */
  ...
  { "crypt_autosign",   DT_BOOL, R_NONE, IP &OPT_CRYPT_AUTOSIGN, 0 },
  /*
  ** .pp
  ...
  ** (Crypto only)
  */
  { "crypt_autosmime",  DT_BOOL, R_NONE, IP &OPT_CRYPT_AUTOSMIME, 1 },
  /*
  ** .pp
  ** This variable controls whether or not NeoMutt may automatically enable
  ...
  ** $$crypt_autosign, $$crypt_replysign and $$smime_is_default.
  */
  { "crypt_confirmhook",        DT_BOOL, R_NONE, IP &OPT_CRYPT_CONFIRMHOOK, 1 },
  /*
  ** .pp
  ...
  ** typos are concerned.
  */
  { "crypt_opportunistic_encrypt", DT_BOOL, R_NONE, IP &OPT_CRYPT_OPPORTUNISTIC_ENCRYPT, 0 },
  /*
  ** .pp
  ...
  ** (Crypto only)
  ...
  { "crypt_replyencrypt",       DT_BOOL, R_NONE, IP &OPT_CRYPT_REPLYENCRYPT, 1 },
  /*
  ** .pp
  ...
  */
  ...
  { "crypt_replysign",  DT_BOOL, R_NONE, IP &OPT_CRYPT_REPLYSIGN, 0 },
  /*
  ** .pp
  ...
  */
  ...
  { "crypt_replysignencrypted", DT_BOOL, R_NONE, IP &OPT_CRYPT_REPLYSIGNENCRYPTED, 0 },
  /*
  ** .pp
  ...
  ** (Crypto only)
  */
  { "crypt_timestamp", DT_BOOL, R_NONE, IP &OPT_CRYPT_TIMESTAMP, 1 },
  /*
  ** .pp
  ...
  ** (Crypto only)
  */
  { "crypt_use_gpgme",  DT_BOOL, R_NONE, IP &OPT_CRYPT_USE_GPGME, 0 },
  /*
  ** .pp
  ...
  */
  { "crypt_use_pka", DT_BOOL, R_NONE, IP &OPT_CRYPT_USE_PKA, 0 },
  /*
  ** .pp
  ...
  */
  ...
  { "crypt_verify_sig", DT_QUAD, R_NONE, IP &OPT_CRYPT_VERIFY_SIG, MUTT_YES },
  /*
  ** .pp
  ...
  ** regular expression.
  */
  { "delete",           DT_QUAD, R_NONE, IP &OPT_DELETE, MUTT_ASKYES },
  /*
  ** .pp
  ...
  */
  { "delete_untag",     DT_BOOL, R_NONE, IP &OPT_DELETE_UNTAG, 1 },
  /*
  ** .pp
  ...
  */
  { "digest_collapse",  DT_BOOL, R_NONE, IP &OPT_DIGEST_COLLAPSE, 1 },
  /*
  ** .pp
  ...
  ** depends on the server whether DSN will be used or not.
  */
  { "duplicate_threads",        DT_BOOL, R_RESORT|R_RESORT_INIT|R_INDEX, IP &OPT_DUPLICATE_THREADS, 1 },
  /*
  ** .pp
  ...
  ** in the thread tree.
  */
  { "edit_headers",     DT_BOOL, R_NONE, IP &OPT_EDIT_HEADERS, 0 },
  /*
  ** .pp
  ...
  */
  { "encode_from",      DT_BOOL, R_NONE, IP &OPT_ENCODE_FROM, 0 },
  /*
  ** .pp
  ...
  */
  { "fast_reply",       DT_BOOL, R_NONE, IP &OPT_FAST_REPLY, 0 },
  /*
  ** .pp
  ...
  */
  { "fcc_attach",       DT_QUAD, R_NONE, IP &OPT_FCC_ATTACH, MUTT_YES },
  /*
  ** .pp
  ** This variable controls whether or not attachments on outgoing messages
  ** are saved along with the main body of your message.
  */
  { "fcc_clear",        DT_BOOL, R_NONE, IP &OPT_FCC_CLEAR, 0 },
  /*
  ** .pp
  ...
  ** (PGP only)
  */
  { "flag_safe", DT_BOOL, R_NONE, IP &OPT_FLAG_SAFE, 0 },
  /*
  ** .pp
  ...
  */
  { "followup_to",      DT_BOOL, R_NONE, IP &OPT_FOLLOWUP_TO, 1 },
  /*
  ** .pp
  ...
  */
#ifdef USE_NNTP
  { "followup_to_poster", DT_QUAD, R_NONE, IP &OPT_FOLLOWUP_TO_POSTER, MUTT_ASKYES },
  /*
  ** .pp
  ...
  */
#endif
  { "force_name",       DT_BOOL, R_NONE, IP &OPT_FORCE_NAME, 0 },
  /*
  ** .pp
  ...
  ** the section on $$index_format.  See also $$attribution_locale.
  */
  { "forward_decode",   DT_BOOL, R_NONE, IP &OPT_FORWARD_DECODE, 1 },
  /*
  ** .pp
  ...
  */
  ...
  /*
  */
  { "forward_decrypt",  DT_BOOL, R_NONE, IP &OPT_FORWARD_DECRYPT, 1 },
  /*
  ** .pp
  ...
  */
  ...
  /*
  */
  { "forward_edit",     DT_QUAD, R_NONE, IP &OPT_FORWARD_EDIT, MUTT_YES },
  /*
  ** .pp
  ...
  */
  ...
  /*
  */
  { "forward_quote",    DT_BOOL, R_NONE, IP &OPT_FORWARD_QUOTE, 0 },
  /*
  ** .pp
  ...
  */
  ...
  /*
  */
  { "forward_references", DT_BOOL, R_NONE, IP &OPT_FORWARD_REFERENCES, 0 },
  /*
  ** .pp
  ...
  */
  ...
  /*
  */
  { "hdrs",             DT_BOOL, R_NONE, IP &OPT_HDRS, 1 },
  /*
  ** .pp
  ...
  */
  { "header",           DT_BOOL, R_NONE, IP &OPT_HEADER, 0 },
  /*
  ** .pp
  ...
  */
  ...
  { "header_cache_compress", DT_BOOL, R_NONE, IP &OPT_HEADER_CACHE_COMPRESS, 1 },
  /*
  ** .pp
...
#endif /* USE_HCACHE */
  { "header_color_partial", DT_BOOL, R_PAGER_FLOW, IP &OPT_HEADER_COLOR_PARTIAL, 0 },
  /*
  ** .pp
  ...
  */
  { "help",             DT_BOOL, R_REFLOW, IP &OPT_HELP, 1 },
  /*
  ** .pp
  ...
  */
  { "hidden_host",      DT_BOOL, R_NONE, IP &OPT_HIDDEN_HOST, 0 },
  /*
  ** .pp
  ...
  */
  { "hide_limited",     DT_BOOL, R_TREE|R_INDEX, IP &OPT_HIDE_LIMITED, 0 },
  /*
  ** .pp
  ** When \fIset\fP, NeoMutt will not show the presence of messages that are hidden
  ** by limiting, in the thread tree.
  */
  { "hide_missing",     DT_BOOL, R_TREE|R_INDEX, IP &OPT_HIDE_MISSING, 1 },
  /*
  ** .pp
  ** When \fIset\fP, NeoMutt will not show the presence of missing messages in the
  ** thread tree.
  */
  { "hide_thread_subject", DT_BOOL, R_TREE|R_INDEX, IP &OPT_HIDE_THREAD_SUBJECT, 1 },
  /*
  ** .pp
  ...
  ** displayed sibling.
  */
  { "hide_top_limited", DT_BOOL, R_TREE|R_INDEX, IP &OPT_HIDE_TOP_LIMITED, 0 },
  /*
  ** .pp
  ** When \fIset\fP, NeoMutt will not show the presence of messages that are hidden
  ...
  */
  { "hide_top_missing", DT_BOOL, R_TREE|R_INDEX, IP &OPT_HIDE_TOP_MISSING, 1 },
  /*
  ** .pp
  ...
  */
  { "history_remove_dups", DT_BOOL, R_NONE, IP &OPT_HISTORY_REMOVE_DUPS, 0 },
  /*
  ** .pp
  ...
  */
  { "honor_disposition", DT_BOOL, R_NONE, IP &OPT_HONOR_DISPOSITION, 0 },
  /*
  ** .pp
  ...
  */
  { "honor_followup_to", DT_QUAD, R_NONE, IP &OPT_HONOR_FOLLOWUP_TO, MUTT_YES },
  /*
  ** .pp
  ...
  */
#ifdef HAVE_LIBIDN
  { "idn_decode",       DT_BOOL, R_MENU, IP &OPT_IDN_DECODE, 1 },
  /*
  ** .pp
  ...
  */
  { "idn_encode",       DT_BOOL, R_MENU, IP &OPT_IDN_ENCODE, 1 },
  /*
  ** .pp
  ...
  */
#endif /* HAVE_LIBIDN */
  { "ignore_linear_white_space",    DT_BOOL, R_NONE, IP &OPT_IGNORE_LINEAR_WHITE_SPACE, 0 },
  /*
  ** .pp
  ...
  */
  { "ignore_list_reply_to", DT_BOOL, R_NONE, IP &OPT_IGNORE_LIST_REPLY_TO, 0 },
  /*
  ** .pp
  ...
  */
  { "imap_check_subscribed",  DT_BOOL, R_NONE, IP &OPT_IMAP_CHECK_SUBSCRIBED, 0 },
  /*
   ** .pp
  ...
  */
  { "imap_idle",                DT_BOOL, R_NONE, IP &OPT_IMAP_IDLE, 0 },
  /*
  ** .pp
  ...
  */
  { "imap_list_subscribed",     DT_BOOL, R_NONE, IP &OPT_IMAP_LIST_SUBSCRIBED, 0 },
  /*
  ** .pp
  ...
  */
  { "imap_passive",             DT_BOOL, R_NONE, IP &OPT_IMAP_PASSIVE, 1 },
  /*
  ** .pp
  ...
  ** is slow.
  */
  { "imap_peek", DT_BOOL, R_NONE, IP &OPT_IMAP_PEEK, 1 },
  /*
  ** .pp
  ...
  */
  { "imap_servernoise",         DT_BOOL, R_NONE, IP &OPT_IMAP_SERVERNOISE, 1 },
  /*
  ** .pp
  ...
  */
#endif
  { "implicit_autoview", DT_BOOL,R_NONE, IP &OPT_IMPLICIT_AUTOVIEW, 0 },
  /*
  ** .pp
  ...
  ** form.
  */
  { "include",          DT_QUAD, R_NONE, IP &OPT_INCLUDE, MUTT_ASKYES },
  /*
  ** .pp
  ** Controls whether or not a copy of the message(s) you are replying to
  ** is included in your reply.
  */
  { "include_onlyfirst",        DT_BOOL, R_NONE, IP &OPT_INCLUDE_ONLYFIRST, 0 },
  /*
  ** .pp
  ...
  */
  { "keep_flagged", DT_BOOL, R_NONE, IP &OPT_KEEP_FLAGGED, 0 },
  /*
  ** .pp
  ...
  */
  { "mail_check_recent",DT_BOOL, R_NONE, IP &OPT_MAIL_CHECK_RECENT, 1 },
  /*
  ** .pp
  ...
  */
  { "mail_check_stats", DT_BOOL, R_NONE, IP &OPT_MAIL_CHECK_STATS, 0 },
  /*
  ** .pp
  ...
  */
  { "mailcap_sanitize", DT_BOOL, R_NONE, IP &OPT_MAILCAP_SANITIZE, 1 },
  /*
  ** .pp
  ...
  */
#ifdef USE_HCACHE
  { "maildir_header_cache_verify", DT_BOOL, R_NONE, IP &OPT_MAILDIR_HEADER_CACHE_VERIFY, 1 },
  /*
  ** .pp
  ...
  */
#endif
  { "maildir_trash", DT_BOOL, R_NONE, IP &OPT_MAILDIR_TRASH, 0 },
  /*
  ** .pp
  ...
  ** mailbox types.
  */
  { "maildir_check_cur", DT_BOOL, R_NONE, IP &OPT_MAILDIR_CHECK_CUR, 0 },
  /*
  ** .pp
  ...
  */
  { "mark_old",         DT_BOOL, R_BOTH, IP &OPT_MARK_OLD, 1 },
  /*
  ** .pp
  ...
  */
  { "markers",          DT_BOOL, R_PAGER_FLOW, IP &OPT_MARKERS, 1 },
  /*
  ** .pp
  ...
  */
  { "menu_move_off",    DT_BOOL, R_NONE, IP &OPT_MENU_MOVE_OFF, 1 },
  /*
  ** .pp
  ...
  */
  { "menu_scroll",      DT_BOOL, R_NONE, IP &OPT_MENU_SCROLL, 0 },
  /*
  ** .pp
  ...
  */
  ...
  { "message_cache_clean", DT_BOOL, R_NONE, IP &OPT_MESSAGE_CACHE_CLEAN, 0 },
  /*
  ** .pp
  ...
  */
  ...
  /*
  */
  { "meta_key",         DT_BOOL, R_NONE, IP &OPT_META_KEY, 0 },
  /*
  ** .pp
  ...
  */
  { "mime_forward",     DT_QUAD, R_NONE, IP &OPT_MIME_FORWARD, MUTT_NO },
  /*
  ** .pp
  ...
  */
  { "mime_forward_decode", DT_BOOL, R_NONE, IP &OPT_MIME_FORWARD_DECODE, 0 },
  /*
  ** .pp
  ** Controls the decoding of complex MIME messages into \fCtext/plain\fP when
  ...
  */
  ...
  /*
  */
  { "mime_forward_rest", DT_QUAD, R_NONE, IP &OPT_MIME_FORWARD_REST, MUTT_YES },
  /*
  ** .pp
  ...
  */
#ifdef USE_NNTP
  { "mime_subject",     DT_BOOL, R_NONE, IP &OPT_MIME_SUBJECT, 1 },
  /*
  ** .pp
  ...
  ** ``file -bi''.
  */
  { "mime_type_query_first", DT_BOOL, R_NONE, IP &OPT_MIME_TYPE_QUERY_FIRST, 0 },
  /*
  ** .pp
  ...
  */
#endif
  { "move",             DT_QUAD, R_NONE, IP &OPT_MOVE, MUTT_NO },
  /*
  ** .pp
  ...
  ** a ``$mbox-hook'' command.
  */
  { "narrow_tree",      DT_BOOL, R_TREE|R_INDEX, IP &OPT_NARROW_TREE, 0 },
  /*
  ** .pp
  ...
  */
  { "nntp_listgroup",   DT_BOOL, R_NONE, IP &OPT_NNTP_LISTGROUP, 1 },
  /*
  ** .pp
  ** This variable controls whether or not existence of each article is
  ** checked when newsgroup is entered.
  */
  { "nntp_load_description", DT_BOOL, R_NONE, IP &OPT_NNTP_LOAD_DESCRIPTION, 1 },
  /*
  ** .pp
  ...
  */
   ...
   */
  { "nm_record", DT_BOOL, R_NONE, IP &OPT_NM_RECORD, 0 },
  /*
   ** .pp
  ...
  */
  { "pager_stop",       DT_BOOL, R_NONE, IP &OPT_PAGER_STOP, 0 },
  /*
  ** .pp
  ...
  ** function.
  */
  { "pgp_auto_decode", DT_BOOL, R_NONE, IP &OPT_PGP_AUTO_DECODE, 0 },
  /*
  ** .pp
  ...
  */
  ...
  { "pgp_autoinline",           DT_BOOL, R_NONE, IP &OPT_PGP_AUTOINLINE, 0 },
  /*
  ** .pp
  ...
  ** (PGP only)
  */
  { "pgp_check_exit",   DT_BOOL, R_NONE, IP &OPT_PGP_CHECK_EXIT, 1 },
  /*
  ** .pp
  ...
  ** (PGP only)
  */
  { "pgp_ignore_subkeys", DT_BOOL, R_NONE, IP &OPT_PGP_IGNORE_SUBKEYS, 1 },
  /*
  ** .pp
  ...
  ** (PGP only)
  */
  { "pgp_long_ids",     DT_BOOL, R_NONE, IP &OPT_PGP_LONG_IDS, 1 },
  /*
  ** .pp
  ...
  ** (PGP only)
  */
  { "pgp_mime_auto", DT_QUAD, R_NONE, IP &OPT_PGP_MIME_AUTO, MUTT_ASKYES },
  /*
  ** .pp
  ...
  */
  ...
  { "pgp_replyinline",          DT_BOOL, R_NONE, IP &OPT_PGP_REPLYINLINE, 0 },
  /*
  ** .pp
  ** Setting this variable will cause NeoMutt to always attempt to
  ...
  **
  */
  { "pgp_retainable_sigs", DT_BOOL, R_NONE, IP &OPT_PGP_RETAINABLE_SIGS, 0 },
  /*
  ** .pp
  ...
  ** (PGP only)
  */
  { "pgp_self_encrypt",    DT_BOOL, R_NONE, IP &OPT_PGP_SELF_ENCRYPT, 0 },
  /*
  ** .pp
  ...
  ** (PGP only)
  */
  { "pgp_show_unusable", DT_BOOL, R_NONE, IP &OPT_PGP_SHOW_UNUSABLE, 1 },
  /*
  ** .pp
  ...
  ** (PGP only)
  */
  { "pgp_strict_enc",   DT_BOOL, R_NONE, IP &OPT_PGP_STRICT_ENC, 1 },
  /*
  ** .pp
  ...
  ** (PGP only)
  */
  { "pgp_use_gpg_agent", DT_BOOL, R_NONE, IP &OPT_PGP_USE_GPG_AGENT, 0 },
  /*
  ** .pp
  ...
  ** (PGP only)
  */
  { "pipe_decode",      DT_BOOL, R_NONE, IP &OPT_PIPE_DECODE, 0 },
  /*
  ** .pp
  ...
  */
  { "pipe_split",       DT_BOOL, R_NONE, IP &OPT_PIPE_SPLIT, 0 },
  /*
  ** .pp
  ...
  */
#ifdef USE_POP
  { "pop_auth_try_all", DT_BOOL, R_NONE, IP &OPT_POP_AUTH_TRY_ALL, 1 },
  /*
  ** .pp
  ...
  */
  { "pop_delete",       DT_QUAD, R_NONE, IP &OPT_POP_DELETE, MUTT_ASKNO },
  /*
  ** .pp
  ...
  */
  { "pop_last",         DT_BOOL, R_NONE, IP &OPT_POP_LAST, 0 },
  /*
  ** .pp
  ...
  */
  { "pop_reconnect",    DT_QUAD, R_NONE, IP &OPT_POP_RECONNECT, MUTT_ASKYES },
  /*
  ** .pp
  ...
  */
#ifdef USE_NNTP
  { "post_moderated",   DT_QUAD, R_NONE, IP &OPT_POST_MODERATED, MUTT_ASKYES },
  /*
  ** .pp
  ...
  */
#endif
  { "postpone",         DT_QUAD, R_NONE, IP &OPT_POSTPONE, MUTT_ASKYES },
  /*
  ** .pp
  ...
  */
  { "postpone_encrypt",    DT_BOOL, R_NONE, IP &OPT_POSTPONE_ENCRYPT, 0 },
  /*
  ** .pp
  ...
  */
#endif /* USE_SOCKET */
  { "print",            DT_QUAD, R_NONE, IP &OPT_PRINT, MUTT_ASKNO },
  /*
  ** .pp
  ...
  */
  ...
  /*
  */
  { "print_decode",     DT_BOOL, R_NONE, IP &OPT_PRINT_DECODE, 1 },
  /*
  ** .pp
  ...
  */
  { "print_split",      DT_BOOL, R_NONE, IP &OPT_PRINT_SPLIT,  0 },
  /*
  ** .pp
  ...
  */
  { "prompt_after",     DT_BOOL, R_NONE, IP &OPT_PROMPT_AFTER, 1 },
  /*
  ** .pp
  ...
  */
  { "quit",             DT_QUAD, R_NONE, IP &OPT_QUIT, MUTT_YES },
  /*
  ** .pp
  ...
  */
  { "read_only",        DT_BOOL, R_NONE, IP &OPT_READ_ONLY, 0 },
  /*
  ** .pp
  ...
  */
  { "recall",           DT_QUAD, R_NONE, IP &OPT_RECALL, MUTT_ASKYES },
  /*
  ** .pp
  ...
  */
  { "reflow_space_quotes",      DT_BOOL, R_NONE, IP &OPT_REFLOW_SPACE_QUOTES, 1 },
  /*
  ** .pp
  ...
  */
  { "reflow_text",      DT_BOOL, R_NONE, IP &OPT_REFLOW_TEXT, 1 },
  /*
  ** .pp
  ...
  ** the German "Aw:".
  */
  { "reply_self",       DT_BOOL, R_NONE, IP &OPT_REPLY_SELF, 0 },
  /*
  ** .pp
  ...
  */
  { "reply_to",         DT_QUAD, R_NONE, IP &OPT_REPLY_TO, MUTT_ASKYES },
  /*
  ** .pp
  ...
  */
  { "reply_with_xorig", DT_BOOL, R_NONE, IP &OPT_REPLY_WITH_XORIG, 0 },
  /*
  ** .pp
  ...
  */
  { "resolve",          DT_BOOL, R_NONE, IP &OPT_RESOLVE, 1 },
  /*
  ** .pp
  ...
  */
  { "resume_draft_files", DT_BOOL, R_NONE, IP &OPT_RESUME_DRAFT_FILES, 0 },
  /*
  ** .pp
  ...
  */
  { "resume_edited_draft_files", DT_BOOL, R_NONE, IP &OPT_RESUME_EDITED_DRAFT_FILES, 1 },
  /*
  ** .pp
  ...
  */
  { "reverse_alias",    DT_BOOL, R_BOTH, IP &OPT_REVERSE_ALIAS, 0 },
  /*
  ** .pp
  ...
  */
  { "reverse_name",     DT_BOOL, R_BOTH, IP &OPT_REVERSE_NAME, 0 },
  /*
  ** .pp
  ...
  ** Also see the ``$alternates'' command.
  */
  { "reverse_realname", DT_BOOL, R_BOTH, IP &OPT_REVERSE_REALNAME, 1 },
  /*
  ** .pp
  ...
  */
  { "rfc2047_parameters", DT_BOOL, R_NONE, IP &OPT_RFC2047_PARAMETERS, 0 },
  /*
  ** .pp
  ...
  */
  { "save_address",     DT_BOOL, R_NONE, IP &OPT_SAVE_ADDRESS, 0 },
  /*
  ** .pp
  ...
  */
  { "save_empty",       DT_BOOL, R_NONE, IP &OPT_SAVE_EMPTY, 1 },
  /*
  ** .pp
  ...
  ** $$history_file file.
  */
  { "save_name",        DT_BOOL, R_NONE, IP &OPT_SAVE_NAME, 0 },
  /*
  ** .pp
  ...
  */
  { "score",            DT_BOOL, R_NONE, IP &OPT_SCORE, 1 },
  /*
  ** .pp
  ...
  */
#ifdef USE_NNTP
  { "save_unsubscribed", DT_BOOL, R_NONE, IP &OPT_SAVE_UNSUBSCRIBED, 0 },
  /*
  ** .pp
  ** When \fIset\fP, info about unsubscribed newsgroups will be saved into
  ** ``newsrc'' file and into cache.
  */
  { "show_new_news",    DT_BOOL, R_NONE, IP &OPT_SHOW_NEW_NEWS, 1 },
  /*
  ** .pp
  ...
  */
  { "show_only_unread", DT_BOOL, R_NONE, IP &OPT_SHOW_ONLY_UNREAD, 0 },
  /*
  ** .pp
  ...
  */
  { "sidebar_folder_indent", DT_BOOL, R_SIDEBAR, IP &OPT_SIDEBAR_FOLDER_INDENT, 0 },
  /*
  ** .pp
  ...
  */
  { "sidebar_new_mail_only", DT_BOOL, R_SIDEBAR, IP &OPT_SIDEBAR_NEW_MAIL_ONLY, 0 },
  /*
  ** .pp
  ...
  */
  { "sidebar_next_new_wrap", DT_BOOL, R_NONE, IP &OPT_SIDEBAR_NEXT_NEW_WRAP, 0 },
  /*
  ** .pp
  ...
  ** the end of the list.
  */
  { "sidebar_on_right", DT_BOOL, R_BOTH|R_REFLOW, IP &OPT_SIDEBAR_ON_RIGHT, 0 },
  /*
  ** .pp
  ** When set, the sidebar will appear on the right-hand side of the screen.
  */
  { "sidebar_short_path", DT_BOOL, R_SIDEBAR, IP &OPT_SIDEBAR_SHORT_PATH, 0 },
  /*
  ** .pp
  ...
  */
  { "sidebar_visible", DT_BOOL, R_REFLOW, IP &OPT_SIDEBAR_VISIBLE, 0 },
  /*
  ** .pp
  ...
  */
#endif
  { "sig_dashes",       DT_BOOL, R_NONE, IP &OPT_SIG_DASHES, 1 },
  /*
  ** .pp
  ...
  */
  { "sig_on_top",       DT_BOOL, R_NONE, IP &OPT_SIG_ON_TOP, 0 },
  /*
  ** .pp
  ...
  */
  { "smart_wrap",       DT_BOOL, R_PAGER_FLOW, IP &OPT_SMART_WRAP, 1 },
  /*
  ** .pp
  ...
  */
  { "smime_ask_cert_label",     DT_BOOL, R_NONE, IP &OPT_SMIME_ASK_CERT_LABEL, 1 },
  /*
  ** .pp
  ...
  ** (S/MIME only)
  */
  { "smime_decrypt_use_default_key",    DT_BOOL, R_NONE, IP &OPT_SMIME_DECRYPT_USE_DEFAULT_KEY, 1 },
  /*
  ** .pp
  ...
  ** (S/MIME only)
  */
  { "smime_is_default", DT_BOOL,  R_NONE, IP &OPT_SMIME_IS_DEFAULT, 0 },
  /*
  ** .pp
  ...
  ** (S/MIME only)
  */
  { "smime_self_encrypt",    DT_BOOL, R_NONE, IP &OPT_SMIME_SELF_ENCRYPT, 0 },
  /*
  ** .pp
  ...
  ** order (example: ``\fCset sort_browser=reverse-date\fP'').
  */
  { "sort_re",          DT_BOOL, R_INDEX|R_RESORT|R_RESORT_INIT, IP &OPT_SORT_RE, 1 },
  /*
  ** .pp
  ...
  ** key.
  */
  { "ssl_force_tls",            DT_BOOL, R_NONE, IP &OPT_SSL_FORCE_TLS, 0 },
  /*
   ** .pp
  ...
  */
#endif /* USE_SSL_GNUTLS */
  { "ssl_starttls", DT_QUAD, R_NONE, IP &OPT_SSL_STARTTLS, MUTT_YES },
  /*
  ** .pp
  ...
  */
#ifdef USE_SSL_OPENSSL
  { "ssl_use_sslv2", DT_BOOL, R_NONE, IP &OPT_SSL_USE_SSLV2, 0 },
  /*
  ** .pp
  ...
  */
  ...
  { "ssl_use_sslv3", DT_BOOL, R_NONE, IP &OPT_SSL_USE_SSLV3, 0 },
  /*
  ** .pp
  ...
  ** considered fundamentally insecure and are no longer recommended.
  */
  { "ssl_use_tlsv1", DT_BOOL, R_NONE, IP &OPT_SSL_USE_TLSV1, 1 },
  /*
  ** .pp
  ** This variable specifies whether to attempt to use TLSv1.0 in the
  ** SSL authentication process.
  */
  { "ssl_use_tlsv1_1", DT_BOOL, R_NONE, IP &OPT_SSL_USE_TLSV1_1, 1 },
  /*
  ** .pp
  ** This variable specifies whether to attempt to use TLSv1.1 in the
  ** SSL authentication process.
  */
  { "ssl_use_tlsv1_2", DT_BOOL, R_NONE, IP &OPT_SSL_USE_TLSV1_2, 1 },
  /*
  ** .pp
  ...
  */
#ifdef USE_SSL_OPENSSL
  { "ssl_usesystemcerts", DT_BOOL, R_NONE, IP &OPT_SSL_USESYSTEMCERTS, 1 },
  /*
  ** .pp
  ...
  */
#endif
  { "ssl_verify_dates", DT_BOOL, R_NONE, IP &OPT_SSL_VERIFY_DATES, 1 },
  /*
  ** .pp
  ...
  */
  { "ssl_verify_host", DT_BOOL, R_NONE, IP &OPT_SSL_VERIFY_HOST, 1 },
  /*
  ** .pp
  ** If \fIset\fP (the default), NeoMutt will not automatically accept a server
  ...
  */
  ...
  { "ssl_verify_partial_chains", DT_BOOL, R_NONE, IP &OPT_SSL_VERIFY_PARTIAL_CHAINS, 0 },
  /*
  ** .pp
  ...
  */
  { "status_on_top",    DT_BOOL, R_REFLOW, IP &OPT_STATUS_ON_TOP, 0 },
  /*
  ** .pp
  ...
  */
  { "strict_threads",   DT_BOOL, R_RESORT|R_RESORT_INIT|R_INDEX, IP &OPT_STRICT_THREADS, 0 },
  /*
  ** .pp
  ...
  ** behavior.
  */
  { "suspend",          DT_BOOL, R_NONE, IP &OPT_SUSPEND, 1 },
  /*
  ** .pp
  ...
  */
  { "text_flowed",      DT_BOOL, R_NONE, IP &OPT_TEXT_FLOWED,  0 },
  /*
  ** .pp
  ...
  */
  { "thorough_search",  DT_BOOL, R_NONE, IP &OPT_THOROUGH_SEARCH, 1 },
  /*
  ** .pp
  ...
  */
  { "thread_received",  DT_BOOL, R_RESORT|R_RESORT_INIT|R_INDEX, IP &OPT_THREAD_RECEIVED, 0 },
  /*
  ** .pp
  ** When \fIset\fP, NeoMutt uses the date received rather than the date sent
  ** to thread messages by subject.
  */
  { "tilde",            DT_BOOL, R_PAGER, IP &OPT_TILDE, 0 },
  /*
  ** .pp
  ...
  ** ``$$status_format''.
  */
  { "ts_enabled",        DT_BOOL,  R_BOTH, IP &OPT_TS_ENABLED, 0 },
  ...
  */
#endif
  { "uncollapse_jump",  DT_BOOL, R_NONE, IP &OPT_UNCOLLAPSE_JUMP, 0 },
  /*
  ** .pp
  ** When \fIset\fP, NeoMutt will jump to the next unread message, if any,
  ** when the current thread is \fIun\fPcollapsed.
  */
  { "uncollapse_new",   DT_BOOL, R_NONE, IP &OPT_UNCOLLAPSE_NEW, 1 },
  /*
  ** .pp
  ...
  */
  { "use_8bitmime",     DT_BOOL, R_NONE, IP &OPT_USE_8BITMIME, 0 },
  /*
  ** .pp
  ...
  */
  { "use_domain",       DT_BOOL, R_NONE, IP &OPT_USE_DOMAIN, 1 },
  /*
  ** .pp
  ...
  */
  { "use_envelope_from",        DT_BOOL, R_NONE, IP &OPT_USE_ENVELOPE_FROM, 0 },
  /*
   ** .pp
  ...
  /*
  */
  { "use_from",         DT_BOOL, R_NONE, IP &OPT_USE_FROM, 1 },
  /*
  ** .pp
  ...
  */
  ...
  { "use_ipv6",         DT_BOOL, R_NONE, IP &OPT_USE_IPV6, 1 },
  /*
  ** .pp
  ...
  */
  ...
  { "user_agent",       DT_BOOL, R_NONE, IP &OPT_USER_AGENT, 1 },
  /*
  ** .pp
  ...
  */
  { "virtual_spoolfile", DT_BOOL, R_NONE, IP &OPT_VIRTUAL_SPOOLFILE, 0 },
  /*
  ** .pp
  ...
  */
#endif
  { "wait_key",         DT_BOOL, R_NONE, IP &OPT_WAIT_KEY, 1 },
  /*
  ** .pp
  ...
  */
  { "weed",             DT_BOOL, R_NONE, IP &OPT_WEED, 1 },
  /*
  ** .pp
  ...
  */
  { "wrap_search",      DT_BOOL, R_NONE, IP &OPT_WRAP_SEARCH, 1 },
  /*
  ** .pp
  ...
  */
  { "write_bcc",        DT_BOOL, R_NONE, IP &OPT_WRITE_BCC, 1 },
  /*
  ** .pp
  ...
  */
#ifdef USE_NNTP
  { "x_comment_to",     DT_BOOL, R_NONE, IP &OPT_X_COMMENT_TO, 0 },
  /*
  ** .pp
  ...
  */
#endif
  { "collapse_all",     DT_BOOL, R_NONE, IP &OPT_COLLAPSE_ALL, 0 },
  /*
  ** .pp
  ** When \fIset\fP, NeoMutt will collapse all threads when entering a folder.
  */
  /*--*/
  { "pgp_encrypt_self",   DT_QUAD, R_NONE, IP &OPT_PGP_ENCRYPT_SELF,   MUTT_NO },
  { "smime_encrypt_self", DT_QUAD, R_NONE, IP &OPT_SMIME_ENCRYPT_SELF, MUTT_NO },
  { NULL, 0, 0, 0, 0 },
};
